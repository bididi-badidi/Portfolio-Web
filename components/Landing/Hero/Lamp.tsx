...
export const LampContainer = ({
  ...
  return (
    <ScrollableSection
      id="hero"
      className={cn(
        "relative grid place-item-center min-h-screen flex-col items-center justify-center overflow-hidden bg-background w-full rounded-md mb-0 lg:mb-0",
        className
      )}
    >
      <div className="absolute top-50 flex w-full flex-1 scale-y-125 items-center justify-center isolate">
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-accent-light blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-accent-light "
        ></motion.div>
